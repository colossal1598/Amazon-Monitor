...
class TitleBlacklistPhrasesTests(unittest.TestCase):
    ...
    def test_whitelist_bypasses_title_blacklist(self) -> None:
        raw = [
            {
                "asin": "B022222222",
                "title": "Magic The Gathering Secret Lair Pokemon TCG",
                "price": 39.99,
                "price_text": "$39.99",
                "in_stock": True,
                "shipping_text": "FREE delivery",
        ...
        cfg = {
            "required_keywords": ["pokemon", "tcg"],
            "whitelist": ["B022222222"],
            "blacklist": [],
            "title_blacklist_phrases": ["magic the gathering"],
        }
        filtered, _meta = run_search_filter_pipeline(raw, cfg)
        self.assertEqual(len(filtered), 1)
        self.assertEqual(filtered[0]["asin"], "B022222222")
